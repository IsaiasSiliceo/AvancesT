...
plot 'WehrlPares(copia).dat' using 1:3 index 0 with linespoints title 'k=64' lw 2,'WehrlImpares(copia).dat' using 1:3 index 0 with linespoints title 'k=65' lw 2

#Gráfica 12
plot 'WehrlPares(copia).dat' using 1:3 index 2 with linespoints title 'k=68' lw 2,'WehrlImpares(copia).dat' using 1:3 index 2 with linespoints title 'k=69' lw 2

#Gráfica 21
plot 'WehrlPares(copia).dat' using 1:3 index 1 with linespoints title 'k=66' lw 2,'WehrlImpares(copia).dat' using 1:3 index 1 with linespoints title 'k=67' lw 2

#Gráfica 22
plot 'WehrlPares(copia).dat' using 1:3 index 3 with linespoints title 'k=70' lw 2,'WehrlImpares(copia).dat' using 1:3 index 3 with linespoints title 'k=71' lw 2
