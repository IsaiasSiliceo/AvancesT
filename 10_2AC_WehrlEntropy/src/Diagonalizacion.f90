...
! the energy spectrum Ek as a function of gammax
 program Entropy
   ...
   integer :: i,ii,bb,n,j,Ite,states(2), pairs(14)
   ...
   character(len=19) :: file2
   character(len=8):: gamma
   character(len=10):: valores
   character(len=18):: string1
   character(len=22)::string2
   character(len=13) :: string3

   gamma = 'gmx7.dat'
   valores = 'Evals7.dat'
   string1 =  '28_72/gmx/'//gamma
   string2 = '28_72/evals/'//valores
   string3 = '28_72/states/'
   bb = 7
   pairs = (/64,65,66,67,68,69,70,71,72,73,74,75,76,77/)
   ...
   do ii=1,2 ! Number of states
      write (file2, "(A13,I2,A4)") string3,states(ii),".dat"
